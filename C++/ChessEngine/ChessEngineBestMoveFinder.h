...
private:
    ...
    static void PrintLookingForEqualMoveFromChosenMovesPaths(const std::vector<std::vector<std::string>>& LastChosenMovesPathsToMate, const std::string& LastEngineMoveFrom, const std::string& LastEngineMoveTo, const std::string& LastOpponentMoveFrom, const std::string& LastOpponentMoveTo);
private:
