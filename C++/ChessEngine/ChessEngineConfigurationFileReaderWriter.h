...
#ifndef _CHESS_ENGINE_CONFIGURATION_FILE_READER_WRITER_H_
#define _CHESS_ENGINE_CONFIGURATION_FILE_READER_WRITER_H_
...
inline ChessEngineConfigurationFileReaderWriter ChessEngineConfigurationFileReaderWriterObject;
