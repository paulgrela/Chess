...
#ifndef _CHESS_ENGINE_CHESS_BOARD_PRINTER_H_
#define _CHESS_ENGINE_CHESS_BOARD_PRINTER_H_
...
private:
    static inline std::mutex CoutForPrintingChessBoardInColorsMutexObject;
private:
