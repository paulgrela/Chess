...
std::string GetDurationTimeFromNanoInOneLineStr(const std::uint64_t DurationTimeNanoCount, const char* TextToPrint, const char* ExceptionTextToPrint);
...
void PrintDurationTimeAllFormats(const std::chrono::high_resolution_clock::time_point start_time, const std::chrono::high_resolution_clock::time_point stop_time, const char* TextToPrint, const char* ExceptionTextToPrint);
