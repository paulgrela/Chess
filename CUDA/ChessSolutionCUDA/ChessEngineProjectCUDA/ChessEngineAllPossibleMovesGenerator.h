...
private:
	[[nodiscard]] std::vector<ChessMove> GetChessMovesPathsVector(const LengthType DeepLevelPathLength) const noexcept;
private:
...
private:
	void SaveChessBoardStateForCUDAThreadsExecution() noexcept;
private:
