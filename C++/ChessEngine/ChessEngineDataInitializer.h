...
public:
	explicit ChessEngineDataInitializer(ChessEngineAllPossibleMovesGenerator& ChessEngineAllPossibleMovesGeneratorLocalReferenceParameter): ChessEngineAllPossibleMovesGeneratorLocalReference(ChessEngineAllPossibleMovesGeneratorLocalReferenceParameter)
	{
	}
public:
