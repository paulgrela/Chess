...
constexpr ThreadNumType MaxNumberOfThreads = 64;
constexpr LengthType MaximalLengthOfFoundPath = 10;
...
constexpr char ChessBoardHorizontalLineSeparatorChar = '-';
...
constexpr LengthType MaxNumberOfChessBoardsForFastExecution = 2 * 4096 * 1024;
